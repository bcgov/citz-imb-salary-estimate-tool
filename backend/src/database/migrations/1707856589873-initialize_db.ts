...
export class InitializeDb1707856589873 implements MigrationInterface {
  name = 'InitializeDb1707856589873';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "mccf_classification" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdOn" TIMESTAMP NOT NULL DEFAULT now(), "lastUpdated" TIMESTAMP NOT NULL DEFAULT now(), "classification" character varying NOT NULL, "minimum_salary" integer NOT NULL, "maximum_salary" integer NOT NULL, CONSTRAINT "PK_0778a7dfed09fc69de8482f1328" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "inquiry" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdOn" TIMESTAMP NOT NULL DEFAULT now(), "lastUpdated" TIMESTAMP NOT NULL DEFAULT now(), "state" "public"."inquiry_state_enum" NOT NULL DEFAULT 'draft', "inquiry_completion_date" TIMESTAMP, "candidate_first_name" character varying NOT NULL, "candidate_last_name" character varying NOT NULL, "current_position_number" character varying, "current_position_title" character varying NOT NULL, "current_ministry_id" uuid, "current_annual_salary" integer NOT NULL, "current_mccf_classification" character varying NOT NULL, "experience_level_id" uuid, "new_position_number" character varying NOT NULL, "new_position_title" character varying NOT NULL, "new_mccf_classification_id" uuid, "appointment_id" uuid, "process_id" uuid, "salary_estimate" integer NOT NULL, "hm_comment" character varying NOT NULL, "shr_comment" character varying NOT NULL, "adm_comment" character varying NOT NULL, "hm_user_id" uuid, "shr_user_id" uuid, "adm_user_id" uuid, CONSTRAINT "PK_3e226d0994e8bd24252dd65e1b6" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "inquiry" ADD CONSTRAINT "FK_18f47ae74afef3f08900b2c6aed" FOREIGN KEY ("new_mccf_classification_id") REFERENCES "mccf_classification"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP TABLE "mccf_classification"`);
