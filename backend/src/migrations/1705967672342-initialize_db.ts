...
export class InitializeDb1705967672342 implements MigrationInterface {
  name = 'InitializeDb1705967672342';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "inquiry" ADD CONSTRAINT "FK_2a68bcfcc54acc6e2e7c75eeb88" FOREIGN KEY ("currentMinistryId") REFERENCES "ministry"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "inquiry" ADD CONSTRAINT "FK_48ad6f832458caa5fa36927ddf7" FOREIGN KEY ("experienceLevelId") REFERENCES "experience"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "inquiry" ADD CONSTRAINT "FK_acf591cb7c7ec0d01818ca39347" FOREIGN KEY ("newSalaryRangeId") REFERENCES "salary_range"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "inquiry" ADD CONSTRAINT "FK_78ffdc92444007b67e65fa6a928" FOREIGN KEY ("appointmentId") REFERENCES "appointment"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "inquiry" ADD CONSTRAINT "FK_d86e9f0f3eb13cc21ca2908835f" FOREIGN KEY ("processId") REFERENCES "process"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "inquiry" ADD CONSTRAINT "FK_0a6ce7158d8285c1901451f4673" FOREIGN KEY ("hmUserId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "inquiry" ADD CONSTRAINT "FK_a25365413b9299bc86f41987a14" FOREIGN KEY ("shrUserId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "inquiry" ADD CONSTRAINT "FK_b3111cca940fdd8083fa6f38183" FOREIGN KEY ("admUserId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "inquiry" DROP CONSTRAINT "FK_b3111cca940fdd8083fa6f38183"`,
    );
    await queryRunner.query(
      `ALTER TABLE "inquiry" DROP CONSTRAINT "FK_a25365413b9299bc86f41987a14"`,
    );
    await queryRunner.query(
      `ALTER TABLE "inquiry" DROP CONSTRAINT "FK_0a6ce7158d8285c1901451f4673"`,
    );
    await queryRunner.query(
      `ALTER TABLE "inquiry" DROP CONSTRAINT "FK_d86e9f0f3eb13cc21ca2908835f"`,
    );
    await queryRunner.query(
      `ALTER TABLE "inquiry" DROP CONSTRAINT "FK_78ffdc92444007b67e65fa6a928"`,
    );
    await queryRunner.query(
      `ALTER TABLE "inquiry" DROP CONSTRAINT "FK_acf591cb7c7ec0d01818ca39347"`,
    );
    await queryRunner.query(
      `ALTER TABLE "inquiry" DROP CONSTRAINT "FK_48ad6f832458caa5fa36927ddf7"`,
    );
    await queryRunner.query(
      `ALTER TABLE "inquiry" DROP CONSTRAINT "FK_2a68bcfcc54acc6e2e7c75eeb88"`,
    );
