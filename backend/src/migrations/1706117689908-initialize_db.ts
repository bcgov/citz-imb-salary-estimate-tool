...
export class InitializeDb1706117689908 implements MigrationInterface {
  name = 'InitializeDb1706117689908';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "inquiry" ADD CONSTRAINT "FK_a896b6dd4ac343747d5e6453bca" FOREIGN KEY ("newMccfClassificationId") REFERENCES "salary_range"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "inquiry" DROP CONSTRAINT "FK_a896b6dd4ac343747d5e6453bca"`,
    );
    await queryRunner.query(
