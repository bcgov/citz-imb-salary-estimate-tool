...
export class InitializeDb1706133610020 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "inquiry" ADD CONSTRAINT "FK_f512a4c558d28704f1436a5ec04" FOREIGN KEY ("current_ministry_id") REFERENCES "ministry"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "inquiry" ADD CONSTRAINT "FK_3ac3e15f6d8e1bfb865421474aa" FOREIGN KEY ("experience_level_id") REFERENCES "experience"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "inquiry" ADD CONSTRAINT "FK_18f47ae74afef3f08900b2c6aed" FOREIGN KEY ("new_mccf_classification_id") REFERENCES "salary_range"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "inquiry" ADD CONSTRAINT "FK_9a8be2cf3cc3bb9e9997013d173" FOREIGN KEY ("appointment_id") REFERENCES "appointment"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "inquiry" ADD CONSTRAINT "FK_12327533c1353abe5bbc81b6e8f" FOREIGN KEY ("process_id") REFERENCES "process"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "inquiry" ADD CONSTRAINT "FK_e5696659d5be7af4fcf7c32dc1c" FOREIGN KEY ("hm_user_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "inquiry" ADD CONSTRAINT "FK_c1896b268eb483150cb149429b3" FOREIGN KEY ("shr_user_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "inquiry" ADD CONSTRAINT "FK_fc70b61915bb6df029f7992fafc" FOREIGN KEY ("adm_user_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "inquiry" DROP CONSTRAINT "FK_fc70b61915bb6df029f7992fafc"`);
        await queryRunner.query(`ALTER TABLE "inquiry" DROP CONSTRAINT "FK_c1896b268eb483150cb149429b3"`);
        await queryRunner.query(`ALTER TABLE "inquiry" DROP CONSTRAINT "FK_e5696659d5be7af4fcf7c32dc1c"`);
        await queryRunner.query(`ALTER TABLE "inquiry" DROP CONSTRAINT "FK_12327533c1353abe5bbc81b6e8f"`);
        await queryRunner.query(`ALTER TABLE "inquiry" DROP CONSTRAINT "FK_9a8be2cf3cc3bb9e9997013d173"`);
        await queryRunner.query(`ALTER TABLE "inquiry" DROP CONSTRAINT "FK_18f47ae74afef3f08900b2c6aed"`);
        await queryRunner.query(`ALTER TABLE "inquiry" DROP CONSTRAINT "FK_3ac3e15f6d8e1bfb865421474aa"`);
        await queryRunner.query(`ALTER TABLE "inquiry" DROP CONSTRAINT "FK_f512a4c558d28704f1436a5ec04"`);
